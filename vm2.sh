...
qemu-system-aarch64 \
        ...
        -append "console=ttyAMA0 root=/dev/vda vm=2" \
        -drive file=../alpine-rootfs/rootfs.img,format=raw,snapshot=on \
        -netdev user,id=net0 \
        -device e1000,netdev=net0 \
        -netdev socket,id=net1,connect=127.0.0.1:$PORT \
        -device e1000,netdev=net1,mac=00:00:00:00:00:02 \
        -object filter-dump,id=filter1,netdev=net1,file=/tmp/vm2.pcap
